...
### How to handle imbalanced data sets for classification
 ...
 - oversampling: 对于训练数据偏少的数据，随机选取，重复复制(2x, 3x, 5x, 10x etc.)
   ...
   <p aligh="center">
   <img src="https://github.com/thelostpeace/origin_the_book/blob/master/image/adasyn_1.png?raw=true" width=800/>
   <img src="https://github.com/thelostpeace/origin_the_book/blob/master/image/adasyn_2.png?raw=true" width=800/>
   </p>
